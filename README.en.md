...
**These are actual screenshots from the courtyard project that informed this Skill.** They were produced through iterative modeling, user review and project-specific scripts before packaging this heritage release. They do not demonstrate a fresh end-to-end run of the new Skill, historical authenticity, or final architectural acceptance. Version labels identify the captured state; later views may include additional changes.

### 01 / V16 — Resolve the corridor-to-gate junction

![Low roof termination beside the gate bracket system](docs/images/01-roof-junction.png)

Coordinate the roof edge, tile rows, boards and timber members at a high-to-low junction. Review the relationship to the main columns and brackets rather than trimming a single visible surface.

### 02 / V16 — Make the gable profile continuous

![Wing-building gable and continuous bargeboard profile](docs/images/02-gable.png)

Inspect the meeting of sloping boards and vertical framing at the ridge. A readable overall roof silhouette still needs close-up joint checks.

### 03 / V18 — Separate infill from ornament

![Main hall timber infill and floral ornaments](docs/images/03-timber-infill.png)

Timber panels sit behind the decorative pieces in this project's design interpretation. This treatment is not a universal Tang-period construction rule.

### 04 / V20 — Extend the checked treatment to related buildings

![Gate facade with timber infill, bracket sets and entrance details](docs/images/04-gate-detail.png)

Apply the treatment to the other relevant bays while keeping their actual dimensions and architectural hierarchy. New panels inherit the enclosure tag and the existing animation stage.

### 05 / V19 — Organize the model for staged presentation

![Eight cumulative growth scenes from ground to completed courtyard](docs/images/05-growth-stages.jpg)

Stages 1–8: ground and bases, columns, beams and brackets, purlins and rafters, boards, enclosure and joinery, tiles and ridges, landscape. These are cumulative visibility scenes, not moving-component animation or an approved construction sequence. This image records V19, before the V20 infill additions.
...
See [release notes](RELEASE_NOTES.md) for the scope of this release. Only the authorized model-development screenshots above are included. CAD, SKP files and original client reference images are not included.
